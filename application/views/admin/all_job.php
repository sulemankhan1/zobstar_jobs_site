...
<!-- Mirrored from techydevs.com/demos/themes/html/zobstar/job-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Sep 2020 14:36:45 GMT -->
<head>
    ...
    <!-- Google Fonts -->
    <link href="<?php base_url('https://fonts.googleapis.com/css?family=Noto+Sans+JP:100,300,400,500,700,&amp;display=swap')?>" rel="stylesheet">
    <!-- Template CSS Files -->
...
<!-- end per-loader -->
<?php $this->load->view('layout/front_header')?>
...
<section class="card-area padding-top-100px padding-bottom-100px">
                ...
                <div class="sidebar mt-0">
                    <div class="sidebar-widget">
                        ...
                        <div class="contact-form-action mb-4">
                            <form  action = "<?=site_url("Jobs/view_job") ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="sidebar-option mb-4">
                            ...
                            <select class="category-option-field" name = "category">
                        ...
                        </div><!-- end sidebar-option  Category-->
                    ...
                    </div><!-- end sidebar-widget dateposted -->
                    <div class="sidebar-widget">
                        <div class="billing-form-item">
                            <div class="billing-title-wrap">
                                ...
                                <ul>
                                    <li>
                                        <div class="custom-checkbox">
                                            ...
                                            <label for="chb5" class="font-weight-medium">Manager (5)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb6">
                                            <label for="chb6" class="font-weight-medium">Officer (3)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb7">
                                            <label for="chb7" class="font-weight-medium">Student (9)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb8">
                                            <label for="chb8" class="font-weight-medium">Executive (8)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb9">
                                            <label for="chb9" class="font-weight-medium">Others (7)</label>
                                        </div>
                                    </li>
                                </ul>
                            </div><!-- end billing-content -->
                                ...
                                <ul>
                                    <li>
                                        <div class="custom-checkbox">
                                            ...
                                            <label for="chb10" class="font-weight-medium">Fresh (5)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb11">
                                            <label for="chb11" class="font-weight-medium">Less Than 1 Year (3)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb12">
                                            <label for="chb12" class="font-weight-medium">2 Years(6)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb13">
                                            <label for="chb13" class="font-weight-medium">3 Years(3)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb14">
                                            <label for="chb14" class="font-weight-medium">4 Years(5)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb15">
                                            <label for="chb15" class="font-weight-medium">5 Years(2)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb16">
                                            <label for="chb16" class="font-weight-medium">6 Years(2)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb17">
                                            <label for="chb17" class="font-weight-medium">7 Years(4)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb18">
                                            <label for="chb18" class="font-weight-medium">8 Years +(3)</label>
                                        </div>
                                    </li>
                                </ul>
                            </div><!-- end billing-content -->
                                ...
                                <ul>
                                    <li>
                                        <div class="custom-checkbox">
                                            ...
                                            <label for="chb19" class="font-weight-medium">Male (19)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb20">
                                            <label for="chb20" class="font-weight-medium">Female (30)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb21">
                                            <label for="chb21" class="font-weight-medium">Both (45)</label>
                                        </div>
                                    </li>
                                </ul>
                            </div><!-- end billing-content -->
                                ...
                                <ul>
                                    <li>
                                        <div class="custom-checkbox">
                                            ...
                                            <label for="chb22" class="font-weight-medium">Development (33)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb23">
                                            <label for="chb23" class="font-weight-medium">Management (27)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb24">
                                            <label for="chb24" class="font-weight-medium">Finance (48)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb25">
                                            <label for="chb25" class="font-weight-medium">Html Department (14)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb26">
                                            <label for="chb26" class="font-weight-medium">Seo (27)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb27">
                                            <label for="chb27" class="font-weight-medium">Banking (13)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb28">
                                            <label for="chb28" class="font-weight-medium">Designing (22)</label>
                                        </div>
                                    </li>
                                </ul>
                            </div><!-- end billing-content -->
                                ...
                                <ul>
                                    <li>
                                        <div class="custom-checkbox">
                                            ...
                                            <label for="chb29" class="font-weight-medium">Certificate (16)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb30">
                                            <label for="chb30" class="font-weight-medium">Diploma (26)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb31">
                                            <label for="chb31" class="font-weight-medium">Associate Degree (13)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb32">
                                            <label for="chb32" class="font-weight-medium">Bachelor Degree (28)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb33">
                                            <label for="chb33" class="font-weight-medium">Master’s Degree (43)</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="custom-checkbox">
                                            <input type="checkbox" id="chb34">
                                            <label for="chb34" class="font-weight-medium">Doctorate Degree (27)</label>
                                        </div>
                                    </li>
                                </ul>
                            </div><!-- end billing-content -->
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_5" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                                            <circle style="fill:#2A2B46;" cx="256.003" cy="256.003" r="256.003"></circle>
                                                        <path style="fill:#1C1C2E;" d="M378.109,185.822l-2.539,3.533l-54.687-54.687c-3.281-4.153-6.851-8.18-10.746-12.076
                                                                c-25.901-25.901-60.338-40.166-96.966-40.165c-36.633,0-71.074,14.266-96.978,40.17s-40.171,60.345-40.17,96.978
                                                                c0,35.021,13.046,68.034,36.827,93.504l-0.065,0.065l193.84,193.84c46.011-9.23,87.561-30.789,121.058-61.093l18.21-18.21
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_8" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                            <circle style="fill:#423966;" cx="256" cy="255.997" r="255.997"/>
                                                        <path style="fill:#2C2547;" d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
	v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z"/>
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_11" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                                        <circle style="fill:#4F0A0A;" cx="256.003" cy="256.003" r="256.003"/>
                                                        <path style="fill:#260505;" d="M245.901,114.471c0,0-25.629-4.553-25.966,30.35c-0.337,34.903,17.199,68.625,17.199,68.625
                                                            c-14.163,47.886-44.851,104.54-44.851,104.54c-63.735,26.64-72.504,42.828-76.887,47.886c-2.87,3.312-7.861,18.265,0.098,26.453
                                                            l-0.003,0.003L234.233,511.07c7.177,0.604,14.433,0.931,21.767,0.931c106.526,0,197.844-65.071,236.403-157.628L258.441,120.409
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_14" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                            <circle style="fill:#423966;" cx="256" cy="255.997" r="255.997"/>
                                                        <path style="fill:#2C2547;" d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
	v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z"/>
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_15" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                         viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                        <circle style="fill:#423966;" cx="256" cy="255.997" r="255.997"/>
                                                        <path style="fill:#2C2547;" d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
                                                            v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_16" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                         viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                        <circle style="fill:#263364;" cx="256" cy="256" r="256"/>
                                                        <path style="fill:#151F45;" d="M358.365,200.896c-3.076,1.955-6.348,4.972-9.815,9.046l-10.753-10.753h-44.549v74.864
                                                            L151.473,132.279h-50.524v248.182l130.349,130.349C239.427,511.588,247.665,512,256,512c125.879,0,230.536-90.853,251.978-210.563
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_18" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                                            <circle style="fill:#59480C;" cx="256.003" cy="256.003" r="256.003"/>
                                                        <path style="fill:#382D08;" d="M367.906,206.302c-2.807,1.784-5.794,4.539-8.959,8.257l-9.814-9.814h-40.662v3.953l-48.827-48.827
                                                                l-0.009,0.009c-2.399-2.373-4.972-4.509-7.732-6.391c-7.011-4.776-14.956-7.919-23.837-9.425c-8.88-1.504-22.356-2.26-40.427-2.26
                                                                H96.345v228.391l141.133,141.133c6.118,0.438,12.293,0.672,18.523,0.672c125.835,0,230.461-90.791,251.954-210.438l-92.299-92.299
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_19" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                         viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                        <circle style="fill:#263364;" cx="256" cy="256" r="256"/>
                                                        <path style="fill:#151F45;" d="M358.365,200.896c-3.076,1.955-6.348,4.972-9.815,9.046l-10.753-10.753h-44.549v74.864
                                                            L151.473,132.279h-50.524v248.182l130.349,130.349C239.427,511.588,247.665,512,256,512c125.879,0,230.536-90.853,251.978-210.563
                                ...
                                <div class="job-card job-card-layout">
                                    <div class="job-card-details d-flex align-items-center justify-content-between">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_20" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                                        <circle style="fill:#4F0A0A;" cx="256.003" cy="256.003" r="256.003"/>
                                                        <path style="fill:#260505;" d="M245.901,114.471c0,0-25.629-4.553-25.966,30.35c-0.337,34.903,17.199,68.625,17.199,68.625
                                                            c-14.163,47.886-44.851,104.54-44.851,104.54c-63.735,26.64-72.504,42.828-76.887,47.886c-2.87,3.312-7.861,18.265,0.098,26.453
                                                            l-0.003,0.003L234.233,511.07c7.177,0.604,14.433,0.931,21.767,0.931c106.526,0,197.844-65.071,236.403-157.628L258.441,120.409
	...
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z"/>
                                    ...
                                    <div class="btn-box margin-top-30px">
                                     <button class="theme-btn border-0" type="submit" name="view_job" value = "view_job">Create Account</button>
                                    </div>      
                                </form>
        ...
        <div class="row">
            <div class="col-lg-4 column-td-6">
                <div class="footer-item">
                    <div class="logo">
                        <a href="index.html" class="foot-logo"><img src="<?php base_url('assets/images/logo2.png" alt="logo')?>"></a>
...
<script src="<?php base_url('assets/js/isotope-3.0.6.min.js')?>"></script>
...
<script src="<?php base_url('assets/js/purecounter.js')?>"></script>
<script src="<?php base_url('assets/js/jquery.filer.min.js')?>"></script>
<script src="<?php base_url('assets/js/progresscircle.js')?>"></script>
<script src="<?php base_url('assets/js/smooth-scrolling.js')?>"></script>
