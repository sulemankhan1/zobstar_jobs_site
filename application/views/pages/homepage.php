...
<div class="tag-area padding-top-130px padding-bottom-90px text-center">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    <h2 class="sec__title mb-0">Popular Searches</h2>
        ...
        <div class="row mt-4">
            <div class="col-lg-6 mx-auto">
                ...
                <p class="font-weight-medium mt-3">320,940 new jobs in the last 7 days</p>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            ...
                            <span class="font-weight-medium">(3065)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
                ...
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            ...
                            <span class="font-weight-medium">(2340)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
                ...
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            ...
                            <span class="font-weight-medium">(1240)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 column-td-6">
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            <h4 class="cat__title mb-2">Banking</h4>
                            <span class="font-weight-medium">(1040)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 column-td-6">
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            <h4 class="cat__title mb-2">Sales & Marketing</h4>
                            <span class="font-weight-medium">(7670)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 column-td-6">
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            <h4 class="cat__title mb-2">IT Contractor</h4>
                            <span class="font-weight-medium">(2434)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 column-td-6">
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            <h4 class="cat__title mb-2">Restaurants</h4>
                            <span class="font-weight-medium">(3432)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 column-td-6">
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            <h4 class="cat__title mb-2">Graduate</h4>
                            <span class="font-weight-medium">(2240)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 column-td-6">
                <div class="category-item">
                    <a href="job-grid-view.html" class="cat-fig-box d-block p-4">
                        ...
                        <div class="cat-content">
                            <h4 class="cat__title mb-2">Public Sector</h4>
                            <span class="font-weight-medium">(1240)</span>
                        </div>
                    </a>
                </div><!-- end category-item -->
...
<section class="card-area padding-top-100px padding-bottom-110px">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <h2 class="sec__title">Find Your Career You <br> Deserve it</h2>
                    <p class="sec__desc">
                        Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit <br>
                        facere possimus, omnis voluptas assumenda est, omnis
                    </p>
	...
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z"/>
                    ...
                    <div class="tab-pane fade" id="feature-job" role="tabpanel" aria-labelledby="feature-tab">
                        <div class="row">
                            <div class="col-lg-4 column-td-6">
                                <div class="job-card">
                                    <div class="job-card-content">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                         viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                        <circle style="fill:#263364;" cx="256" cy="256" r="256"/>
                                                        <path style="fill:#151F45;" d="M358.365,200.896c-3.076,1.955-6.348,4.972-9.815,9.046l-10.753-10.753h-44.549v74.864
                                                            L151.473,132.279h-50.524v248.182l130.349,130.349C239.427,511.588,247.665,512,256,512c125.879,0,230.536-90.853,251.978-210.563
                                            ...
                                            <div class="company-title-box">
                                                <h4 class="card-title mb-1"><a href="employer-details.html">TechyNectar</a> </h4>
                                                <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen, United Kingdom</p>
                                            </div>
                                        </div>
                                        <div class="card-content mt-4 margin-bottom-30px">
                                ...
                                <div class="job-card">
                                    <div class="job-card-content">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_8" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                         viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                        <circle style="fill:#423966;" cx="256" cy="255.997" r="255.997"/>
                                                        <path style="fill:#2C2547;" d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
                                                            v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
                                ...
                                <div class="job-card">
                                    <div class="job-card-content">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_9" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                         viewBox="0 0 512.007 512.007" style="enable-background:new 0 0 512.007 512.007;" xml:space="preserve">
                                                            <circle style="fill:#2A2B46;" cx="256.003" cy="256.003" r="256.003"/>
                                                        <path style="fill:#1C1C2E;" d="M378.109,185.822l-2.539,3.533l-54.687-54.687c-3.281-4.153-6.851-8.18-10.746-12.076
                                                                c-25.901-25.901-60.338-40.166-96.966-40.165c-36.633,0-71.074,14.266-96.978,40.17s-40.171,60.345-40.17,96.978
                                            ...
                                            <div class="company-title-box">
                                                <h4 class="card-title mb-1"><a href="employer-details.html">Unbold</a> </h4>
                                                <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen, United Kingdom</p>
                                            </div>
                                        </div>
                                        <div class="card-content mt-4 margin-bottom-30px">
                                ...
                                <div class="job-card">
                                    <div class="job-card-content">
                                        <div class="card-head d-flex align-items-center">
                                            <div class="company-avatar mr-3">
                                                <a href="employer-details.html" class="d-block">
                                                    <svg class="card-svg" version="1.1" id="Capa_10" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                            <circle style="fill:#423966;" cx="256" cy="255.997" r="255.997"/>
                                                        <path style="fill:#2C2547;" d="M339.155,145.196h-27.717v27.717l-27.717-27.717h-27.717v27.535h-0.173l-55.262-55.261h-27.717
	v27.717l-27.718-27.717h-27.717c0,13.471,0,266.548,0,277.059l116.513,116.513c7.277,0.622,14.636,0.958,22.075,0.958
	c122.181,0,224.354-85.6,249.86-200.095L394.59,200.631v-0.087h-0.087L339.155,145.196z"/>
                                            ...
                                            <div class="company-title-box">
                                                <h4 class="card-title mb-1"><a href="employer-details.html">ThemePress</a> </h4>
                                                <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen, United Kingdom</p>
                                            </div>
                                        </div>
                                        <div class="card-content mt-4 margin-bottom-30px">
                                ...
                                <div class="job-card">
                                    <div class="job-card-content">
                                        <div class="card-head d-flex align-items-center">
                                            ...
                                            <div class="company-title-box">
                                                <h4 class="card-title mb-1"><a href="employer-details.html">PixelSort</a> </h4>
                                                <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen, United Kingdom</p>
                                            </div>
                                        </div>
                                        <div class="card-content mt-4 margin-bottom-30px">
                                ...
                                <div class="job-card">
                                    <div class="job-card-content">
                                        <div class="card-head d-flex align-items-center">
                                            ...
                                            <div class="company-title-box">
                                                <h4 class="card-title mb-1"><a href="employer-details.html">DesingLayer</a> </h4>
                                                <p class="card-sub"><i class="la la-map-marker"></i> Aberdeen, United Kingdom</p>
                                            </div>
                                        </div>
                                        <div class="card-content mt-4 margin-bottom-30px">
...
================================= -->
<section class="clientlogo-area padding-top-95px padding-bottom-90px text-center">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
            ...
            <div class="col-lg-9 mx-auto">
                <div class="client-logo-wrap d-flex flex-wrap justify-content-center align-items-center">
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-2.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-3.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-4.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-5.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-6.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-7.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-8.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-9.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-10.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-11.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="<?=base_url('assets/images/client-logo-3.png')?>" class="img-fluid" alt="brand-image">
                    </div><!-- end client-logo-item -->
